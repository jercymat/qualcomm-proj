...
class SBAAUSFConnection(object):
    ...
    def foward_request(self):
        ...
        print('Fowarded packet to SBA Entity {} at http://{}'.format(next_ent, fw_table[next_ent]))  # Next SBA Entity to foward to
...
while True:
    try:
        connection = SBAAUSFConnection(sock.accept()[0], TEST_MODE)
