...
sba_instance_name = 'SBA_AUSF'


class SBAausfCtrl(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(SBAausfCtrl, self).__init__(*args, **kwargs)
...
class EastWestAPI(ControllerBase):
    def __init__(self, req, link, data, **config):
        ...
        self.AUSF_app = data[sba_instance_name]
    ...
    def _mac_port_table(self, req, **kwargs):
        AUSF_app = self.AUSF_app
        body = json.dumps(AUSF_app.mac_to_port, indent=4) + '\n'
    ...
    def _arp_table(self, req, **kwargs):
        arp_broadcast = self.AUSF_app.arp_broadcast
        arp_str_table = {}
