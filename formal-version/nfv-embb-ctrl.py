...
ue_instance_name = 'NFV_eMBB'


class NFVembbCtrl(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(NFVembbCtrl, self).__init__(*args, **kwargs)
...
class EastWestAPI(ControllerBase):
    def __init__(self, req, link, data, **config):
        ...
        self.eMBB_app = data[ue_instance_name]
    ...
    def _mac_port_table(self, req, **kwargs):
        eMBB_app = self.eMBB_app
        body = json.dumps(eMBB_app.mac_to_port, indent=4) + '\n'
    ...
    def _arp_table(self, req, **kwargs):
        arp_broadcast = self.eMBB_app.arp_broadcast
        arp_str_table = {}
