...
sba_instance_name = 'SBA_UDM'


class SBAudmCtrl(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(SBAudmCtrl, self).__init__(*args, **kwargs)
...
class EastWestAPI(ControllerBase):
    def __init__(self, req, link, data, **config):
        ...
        self.UDM_app = data[sba_instance_name]
    ...
    def _mac_port_table(self, req, **kwargs):
        UDM_app = self.UDM_app
        body = json.dumps(UDM_app.mac_to_port, indent=4) + '\n'
    ...
    def _arp_table(self, req, **kwargs):
        arp_broadcast = self.UDM_app.arp_broadcast
        arp_str_table = {}
