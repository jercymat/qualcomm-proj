...
sba_instance_name = 'SBA_SMF'


class SBAsmfCtrl(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(SBAsmfCtrl, self).__init__(*args, **kwargs)
...
class EastWestAPI(ControllerBase):
    def __init__(self, req, link, data, **config):
        ...
        self.SMF_app = data[sba_instance_name]
    ...
    def _mac_port_table(self, req, **kwargs):
        SMF_app = self.SMF_app
        body = json.dumps(SMF_app.mac_to_port, indent=4) + '\n'
    ...
    def _arp_table(self, req, **kwargs):
        arp_broadcast = self.SMF_app.arp_broadcast
        arp_str_table = {}
