...
sba_instance_name = 'SBA_PCF'


class SBApcfCtrl(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(SBApcfCtrl, self).__init__(*args, **kwargs)
...
class EastWestAPI(ControllerBase):
    def __init__(self, req, link, data, **config):
        ...
        self.PCF_app = data[sba_instance_name]
    ...
    def _mac_port_table(self, req, **kwargs):
        PCF_app = self.PCF_app
        body = json.dumps(PCF_app.mac_to_port, indent=4) + '\n'
    ...
    def _arp_table(self, req, **kwargs):
        arp_broadcast = self.PCF_app.arp_broadcast
        arp_str_table = {}
