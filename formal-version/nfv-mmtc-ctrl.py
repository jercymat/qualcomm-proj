...
ue_instance_name = 'NFV_mMTC'


class NFVmmtcCtrl(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _CONTEXTS = {'wsgi': WSGIApplication}

    def __init__(self, *args, **kwargs):
        super(NFVmmtcCtrl, self).__init__(*args, **kwargs)
...
class EastWestAPI(ControllerBase):
    def __init__(self, req, link, data, **config):
        ...
        self.mMTC_app = data[ue_instance_name]
    ...
    def _mac_port_table(self, req, **kwargs):
        mMTC_app = self.mMTC_app
        body = json.dumps(mMTC_app.mac_to_port, indent=4) + '\n'
    ...
    def _arp_table(self, req, **kwargs):
        arp_broadcast = self.mMTC_app.arp_broadcast
        arp_str_table = {}
